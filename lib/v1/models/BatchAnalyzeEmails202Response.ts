...
export interface BatchAnalyzeEmails202Response {
     ...
     * @memberof BatchAnalyzeEmails202Response
     */
    status?: BatchAnalyzeEmails202ResponseStatusEnum;
    /**
 ...
 * @export
 */
export const BatchAnalyzeEmails202ResponseStatusEnum = {
    Queued: 'QUEUED',
    Processing: 'PROCESSING',
    Completed: 'COMPLETED',
    Error: 'ERROR'
} as const;
export type BatchAnalyzeEmails202ResponseStatusEnum = typeof BatchAnalyzeEmails202ResponseStatusEnum[keyof typeof BatchAnalyzeEmails202ResponseStatusEnum];

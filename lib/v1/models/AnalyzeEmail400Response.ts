...
export function AnalyzeEmail400ResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): AnalyzeEmail400Response {
    if (json == null) {
        return json;
    }
...
export function AnalyzeEmail400ResponseToJSONTyped(value?: AnalyzeEmail400Response | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }

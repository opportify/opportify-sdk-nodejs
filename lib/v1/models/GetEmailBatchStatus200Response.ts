...
export interface GetEmailBatchStatus200Response {
     ...
     * @memberof GetEmailBatchStatus200Response
     */
    status?: GetEmailBatchStatus200ResponseStatusEnum;
    /**
 ...
 * @export
 */
export const GetEmailBatchStatus200ResponseStatusEnum = {
    Queued: 'QUEUED',
    Processing: 'PROCESSING',
    Completed: 'COMPLETED',
    Error: 'ERROR'
} as const;
export type GetEmailBatchStatus200ResponseStatusEnum = typeof GetEmailBatchStatus200ResponseStatusEnum[keyof typeof GetEmailBatchStatus200ResponseStatusEnum];
